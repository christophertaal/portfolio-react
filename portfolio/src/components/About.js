    ...
    return (
        <div>
            <section id="main_about">
                ...
                I finished my Bachelor of Science in Nursing in the Philippines last 2008. I worked well in many countries as health proffesional. I was able to gain a lot of experience that made me realize to connect Informative Technology into the Nursing field.
                </div>
                <div className="container pt-5">
